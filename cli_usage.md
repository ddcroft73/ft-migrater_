...
Usage:  --flag<homepath> <numfiles> <destinationpath>
   ...
   Cleanup:
       --cleanall    Delete all demo files.
                     Delete home path.
                     Delete demo log.
                     Use this command if you did not create a destination, and want the demo
                     files removed from your existing directories.
...
DO NOT EDIT THIS FILE BY HAND, with any other directory names, and run a cleanup. It will delete the directories.
